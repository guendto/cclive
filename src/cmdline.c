...
const char *cmdline_parser_format_values[] = {"flv", "best", "fmt17", "fmt18", "fmt22", "fmt35", "hq", "3gp", "spak-mini", "vp6-hq", "vp6-hd", "vp6", "h264", "hd", "mp4", "ipod", 0}; /*< Possible values for format. */
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* command to run when transfer finishes.  */

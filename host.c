...
/* page handler for sevenload.com */
static int
handle_7load(mem_t page)
{
    /*
     * 1) parse page html for config url 2) parse config for video link
     */
...
/* page handler for liveleak.com */
static int
handle_lleak(mem_t page)
{
    /*
     * 1) parse page html for config url 2) fetch config and parse it for
     * playlist url 3) parse playlist for video link
     */
...
/* page handler for dailymotion.com */
static int
...
/* convert embed link to video page link */
static char    *
...
/* convert lastfm-youtube link to youtube link */
static char    *

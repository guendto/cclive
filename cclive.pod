...
If cclive was built B<without> the WITH_PERL=yes variable, this option
is ignored quietly.
...
Execute I<command> when file transfer reaches I<percent> done defined
...
file transfer reaches I<percent> done.

...
Extract I<format> of the video. If set to I<best>, cclive will
...
Prepend a numeric prefix to the output files.

=item B<-F, --filename-format>=I<formatstring>

Use I<formatstring> to format the output video filename. If any of the following
specifiers appear anywhere in the I<formatstring>, they will be replaced accordingly:
...
cclive downloads "flv" by default from all of the supported websites.
...
=item B<www.funnyhub.com>

=item B<www.myubo.com>

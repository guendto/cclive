...
Possible values are "flv", "mp4", "mp4_hd", "3gpp", "xflv", "spark", "vp6-hq",
"vp6-hd", "vp6", "h264", "spak-mini".
...
Usually all command-line options can be defined in the config file. Note

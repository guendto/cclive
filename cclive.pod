...
Run a I<command> subsequently after extracting video. B<cclive> expects
"%i" specifier to be found in the I<command> for input file, e.g.:
...
(default) and "batch". The difference between these two modes is probably
best explained with a few examples:
  ...
  % cclive -r "mplayer %i" -m batch URL URL2
